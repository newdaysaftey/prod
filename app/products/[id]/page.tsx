            ...
            <div className="p-6 lg:p-8">
              <div className="space-y-6">
                ...
                <div className="border-t border-b border-gray-200 dark:border-gray-700 py-4">
                  ...
                  <br />
                  <div className="flex  sm:flex-row gap-4 items-center justify-start  ">
                    <button className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 transition-all duration-300 ease-in-out hover:scale-105 active:scale-95">
                      Buy Now
                    </button>
                    <button className="px-6 py-3 bg-green-500 text-white font-semibold rounded-lg shadow-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 flex items-center gap-2">

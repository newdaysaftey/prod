...
const First = () => {
  return (
    <section className="bg-tert">
      ...
      <Hero></Hero>
      <br />
      <section className="w-[80%] mx-auto bg-tert">
      <DealHeading Heading="Hot Deals" subHeading="Limited Time offer"></DealHeading>
      </section>
     <div className=" bg-tert pt-10 ">
      <div className="w-[80%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  bg-tert">
        <ProductCard
    ...
    <section className="mt-20 w-[80%] mx-auto bg-tert">
     ...
     <div className=" bg-tert pt-10 ">
      ...
      <DealHeading Heading="Contact Us" subHeading={""} noRadius={true}></DealHeading>
      </section>
